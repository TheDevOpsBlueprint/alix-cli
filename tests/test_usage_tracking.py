...
from alix.usage_tracker import UsageAnalytics, UsageTracker
...
class TestUsageRecord:
    ...
    def test_usage_record_from_dict(self):
        ...
        timestamp = datetime.now()
        data = {"timestamp": timestamp.isoformat(), "context": "test context"}
...
class TestUsageTracker:
    ...
    def test_cleanup_old_data_daily_usage(self, usage_tracker):
        ...
        usage_tracker.tracking_data["daily_usage"] = {old_date: 5, new_date: 3}
    ...
    def test_cleanup_old_data_alias_usage(self, usage_tracker):
        ...
        usage_tracker.tracking_data["alias_usage"] = {
            alias_name: {"total_uses": 2, "last_used": new_date, "usage_dates": [old_date, new_date]}
        }
...
class TestShellWrapper:
    ...
    def test_generate_all_tracking_functions(self, wrapper, temp_dir):
        ...
        aliases = [Alias(name="alias1", command="echo hello"), Alias(name="alias2", command="echo world")]
